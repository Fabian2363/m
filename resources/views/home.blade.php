                    ...
                    <form name="aspnetForm" method="post" action="" id="aspnetForm">
                        <div>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="726D6C56">
                            </div>
	     ...
	     */
                                            ...
                                            <div id="overlay" class="modalWaitExternal" style="display: none;">
                                                <div id="modalWaitInternal">
                                                    <img id="modalWaitImg" width="60px" height="60px" src="./Mi Cuenta_files/wait.gi" alt="">
                                                </div>
                                            </div>
                                            <style>
                                                #overlay {
                                            ...
                                            <div id="ctl00_ContenidoPanel_dvcontenido " class="">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <input type="submit" name="ctl00$ContenidoPanel$ImgCerrar" value="×" id="ctl00_ContenidoPanel_ImgCerrar" title="Cerrar" class="close">
                                                ...
                                                <input name="ctl00$ContenidoPanel$hdnDialogShowId" type="hidden" id="ctl00_ContenidoPanel_hdnDialogShowId" class="hdnDialogShowId" value="dialogLogin">
                                                    ...
                                                    <div class="container n2">
                                                        <div class="row">
                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <div id="ctl00_ContenidoPanel_DIVAlert" class="col-md-12 col-sm-12 col-xs-12  contenedor_1">
                                                                    <div id="ctl00_ContenidoPanel_TextoAlerta" class="alert alert-warning">
                                                                        <div id="ctl00_ContenidoPanel_DIVAlertInf">
                                                                        </div>

                                                                        <div class="col-md-9 col-sm-12 col-xs-12">
                                                                            <span id="ctl00_ContenidoPanel_lblAlert" class="LblAlert"><i class="icon-warning-sign icon-2x"></i>
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                                                    <div class="col-md-3 col-sm-4 col-xs-12 datos_user">
                                                                        <h1>Bienvenido(a):</h1>
                                                                        <h2>
                                                                            <span id="ctl00_ContenidoPanel_lblNombreyApe">{{ Auth::user()->name}}-{{ Auth::user()->apellidos}}</span>
                                                                        </h2>
                                                                        ...
                                                                        <input type="" name="ctl00$ContenidoPanel$Button2" value="Sistema de Informacion Talento Humano" id="" class="btn btn-primary btn-sm btn-block">
                                                                        <ul class="list-group lista-cuenta">
                                                                            <li class="first"><a href="#">Mi
                                                                                    Cuenta</a></li>

                                                                            <li class="list-group-item">
                                                                                <a id="ctl00_ContenidoPanel_HyperLink4" href="{{ url('Informacion_talento_humano') }}">Ver mi informacion en SITH </a>

                                                                            </li>
                                                                            <li class="list-group-item">
                                                                                <a id="ctl00_ContenidoPanel_HyperLink4" href=" {{ url('Actualizacion-informacion-talento-humano') }}">Actualizar mi información </a>
                                                                            </li>
                                                                            <li class="list-group-item">
                                                                                <a id="ctl00_ContenidoPanel_HyperLink5" href=" {{ url('Consultar_Contratos') }}">Ver mis contratos laborales</a>
                                                                            </li>

                                                                            <li class="list-group-item">
                                                                                <a id="ctl00_ContenidoPanel_HyperLink10" href="">Términos
                                                                                    y Condiciones</a>
                                                                            </li>
                                                                            <li class="list-group-item">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-8 col-xs-12 buscador_datos datos_user">

                                                                        <div class="col-md-6 col-sm-12 col-xs-12 sinpadding">
                                                                                ...
                                                                                <table class="table table-striped table-condensed">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblCedula">{{ Auth::user()->cedula }}</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Nombre:</th>
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblNom">{{ Auth::user()->name}}{{ Auth::user()->apellidos }}</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Correo:</th>
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblemail">{{ Auth::user()->email}}</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblFecNacimiento">10
                                                                                                    de Octubre
                                                                                                    1994</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblCanalRegistro">Autoregistro</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblFechaUlt">16
                                                                                                    Agosto de 2021</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Operador:</th>
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblPrestador">CABILDO DE GUAMBIA-ESPIRAL DE EDUCACION</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Punto de atención:</th>
                                                                                            <td>
                                                                                                <span id="ctl00_ContenidoPanel_lblPuntoAtencion">----</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                <a id="ctl00_ContenidoPanel_HyperLink1" class="btn btn-primary" href="">Ver
                                                                                    mi Hoja de Vida</a>
